...
static class AzureIoTHub
{
    ...
    //
    const string deviceConnectionString = "<CXString>";

    //
    // To monitor messages sent to device "device1" use iothub-explorer as follows:
    //    iothub-explorer HostName=ms-formation-iothub.azure-devices.net;SharedAccessKeyName=service;SharedAccessKey=Vs0ybNbiyGKsQZQ8gPSeaHS6MmTXVuojkw9J4PZCaoY= monitor-events "device1"
    //
